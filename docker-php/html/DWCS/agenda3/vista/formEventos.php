        ...
        <div class="card-body">
            <form action="" method="post"  class="mb-3">
                ...
                <div class="mb-3">    
                    ...
                    <input type="datetime-local" name="fecha_inicio" id="fecha_inicio" value="<?=is_null($fecha_inicio)?$fecha_inicio:$fecha_inicio->format('Y-m-d H:i')?>">
                </div>
                <div class="mb-3">    
                    <label for="fecha_fin">Fecha de fin:</label><br>
                    <input type="datetime-local" name="fecha_fin" id="fecha_fin" value="<?=is_null($fecha_fin)?$fecha_inicio:$fecha_fin->format('Y-m-d H:i')?>">
                </div>
